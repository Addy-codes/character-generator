...
class gRPCAPI:
    ...
    def generate_images(self, prompt):
        ...
        answers = self.context.generate(
            prompts=[prompt + f"with a very large head and without a neck as given in <c64117c4-0010-471b-a7b9-caa5663b33a9:1>"],
            weights=[1],
            width=1024,
            height=1024,
            seed=0,
        ...
        # Make sure the directory "./static/images" exists
        output_dir = "./static/images"
        os.makedirs(output_dir, exist_ok=True)

        # Assuming `answers` contains the response from your API
        image_data = answers[generation.ARTIFACT_IMAGE][0]
